...
try:
    ...
    from pipeline.opencti_connector import OpenCTIConnector
    from pipeline.data_processor import CTIDataProcessor
    from pipeline.scheduler import CTIScheduler
    from pipeline.health_check import HealthChecker
...
class PipelineManager:
    ...
    def _init_components(self):
        ...
        try:
            ...
            self.data_processor = CTIDataProcessor()
